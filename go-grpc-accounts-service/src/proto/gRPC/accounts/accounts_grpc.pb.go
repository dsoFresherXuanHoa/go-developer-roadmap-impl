...
type AccountServiceClient interface {
	CreateAccountGrpc(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *accountServiceClient) CreateAccountGrpc(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type AccountServiceServer interface {
	CreateAccountGrpc(context.Context, *Request) (*Response, error)
...
func (UnimplementedAccountServiceServer) CreateAccountGrpc(context.Context, *Request) (*Response, error) {
...
func _AccountService_CreateAccountGrpc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).CreateAccountGrpc(ctx, req.(*Request))
	}
...
var AccountService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "src/proto/accounts.proto",
}
